...
import Floor from './assets/uiux.png'
import civil from './assets/CivilArchitecture.png'
import Animation from './assets/Animations.png'
import Jwellery from './assets/JwelleryModeling.png'
    ...
    <>
        <header> <br /> <br/>
            ...
            <div className="design" ref={cardsSectionRef}>
                <div className="b123">
                    <div className="bx">
                        <img src={Floor} alt="UI/UX" />
                        <h3>3D Floor Plan Internship</h3> <br />
                        <p>we offer a 3D Floor Plans Internship tailored for students and professionals eager to explore the...</p> <br /> <hr />
                        <p>⏱️3 Months | 🗂️Hybrid | 👨‍💼454+ Students</p><hr /> <br />
                    </div>
                    <div className="bx">
                        <img src={civil} alt="Flutter" />
                        <h3>Civil Architecture Internship</h3> <br />
                        <p>we offer a Civil Architecture Internship tailored for students and professionals eager to explore the...</p> <br /> <hr />
                        <p>⏱️3 Months | 🗂️Hybrid | 👨‍💼543+ Students</p><hr /> <br />
                    </div>
                    <div className="bx">
                        <img src={Animation} alt="Native App" />
                        <h3>2D/3D Animation Internship</h3> <br />
                        <p>we offer a 2D/3D Animation tailored for students and professionals eager to explore the...</p> <br /> <hr />
                        <p>⏱️3 Months | 🗂️Hybrid | 👨‍💼243+ Students</p><hr /> <br />
                    </div>
                </div>
                <div className="b123">
                    <div className="bx">
                        <img src={Jwellery} alt="Game Dev" />
                        <h3>Jewellery Modelling Internship</h3> <br />
                        <p>we offer a Jewelery Modelling Internship tailored for students and professionals eager to explore the...</p> <br /> <hr />
                        <p>⏱️3 Months | 🗂️Hybrid | 👨‍💼655+ Students</p><hr /> <br />
                    </div>
                    <div className="bx">
                        <img src={product} alt="Android Dev" />
                        <h3>Product Design Internship</h3> <br />
                        <p>we offer a Product Design Internship tailored for students and professionals eager to explore the...</p> <br /> <hr />
